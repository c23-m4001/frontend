...
export const LandingPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Moneta - Cashflow Management</title>
        <meta
          name="description"
          content="Moneta is a web application for effective cashflow management."
        />
        <meta
          name="keywords"
          content="Moneta, cashflow management, finance, budgeting"
        />
        <meta
          name="og:title"
          content="Moneta - Cashflow Management"
        />
        <meta
          name="og:description"
          content="Moneta is a web application for effective cashflow management."
        ...
        <meta
          name="twitter:image"
          content="https://moneta.mikroskil.com/svgs/moneta-label.svg"
        />
        <meta
          name="robots"
          content="nofollow"
        />
        {/* Add any other relevant SEO tags */}
      </Helmet>
          ...
          <div className="py-24 px-20px sm:px-40px md:px-50px">
            ...
            <div className="space-y-8 md:grid md:grid-cols-1 lg:grid-cols-3 md:gap-12 md:space-y-0 text-center">
              ...
              <div className="bg-white p-20px rounded-xl">
                ...
                <p className="text-paragraph">
                  Keep track of your saving process and reach your financial
                  goals by separating your demands into different wallets.
                </p>
              </div>
              <div className="bg-white p-20px rounded-xl">
                <div className="flex justify-center items-center mb-4">
                ...
                <p className="text-paragraph">
                  Utilize any default category and make as many custom
            ...
            <SwiperSlide>
              <figure className="bg-white border-2 border-dashed border-primary rounded-xl drop-shadow-lg overflow-hidden">
                <blockquote className="p-4 sm:p-8">
                  ...
                  />
                  <p className="text-base px-10px">
                    Moneta telah membantu saya melihat alur keuangan setiap
                    bulan
                  </p>
                </blockquote>
                <div className="w-full flex items-center justify-between px-8 py-4 bg-primary">
